-- Home leaderboard: season totals across all started competitions.

update public.seasons
set
  name = 'Season 1',
  starts_on = '2026-06-06',
  ends_on = '2026-06-06'::date + 70
...
grant execute on function public.get_season_competition_leaderboard(uuid) to anon, authenticated;
