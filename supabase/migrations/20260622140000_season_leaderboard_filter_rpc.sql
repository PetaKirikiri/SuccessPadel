-- Filtered season leaderboard RPC (solo/duos, gender, skill). Replaces single-arg overload.

drop function if exists public.get_season_competition_leaderboard(uuid);
