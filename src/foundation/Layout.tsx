...
import { AppBottomNav } from '../shared/NavBar/AppBottomNav'
  ...
  return (
    <div className="shell-paper game-bg flex min-h-0 w-full min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <main
        ...
        className={`shell-main${isPlaySession ? ' shell-main--play' : ''} min-h-0 min-w-0 flex-1 basis-0 ${
          onPlayerProfile
      ...
      {showBottomNav && !isCompetitionEntry && !onPlayerProfile ? (
