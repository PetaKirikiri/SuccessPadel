...
export function GameScheduleSetup({
  ...
  const scheduleToneClass =
    leftoverMinutes == null
      ? 'border-brand-border/60 bg-brand-bg-alt/35'
      : fits
        ? 'border-green-500/30 bg-green-50/80 dark:border-green-500/25 dark:bg-green-950/25'
        : 'border-red-500/30 bg-red-50/80 dark:border-red-500/25 dark:bg-red-950/25'

  return (
    <div className={`space-y-3 rounded-lg border p-3 ${scheduleToneClass}`}>
      <div>
