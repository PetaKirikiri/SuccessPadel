...
import { Leaderboard as LeaderboardTable } from './Leaderboard'
import { LeaderboardFilters } from './LeaderboardFilters'
import { GamesHubEmpty, GamesHubLoading } from '../InviteCard/GamesHubView'
...
import { leaderboardEmbeddedPadClass } from './Leaderboard.styles'
...
export function Leaderboard({ embedded = false, source = 'season' }: Props) {
  ...
  const embeddedPad = embedded ? leaderboardEmbeddedPadClass : ''
