...
import { IconHubLeaderboard } from '../../shared/NavBar/ShellTabIcons'
import type { TvGameNav } from './TvGameCarousel'

const QR_SIZE = 88
const QR_SIZE_HEADER = 44

/** QR for "watch along" — compact in the TV header bar, or a full aside panel. */
function TvPlayQrPanel({ url, header = false }: { url: string; header?: boolean }) {
