    ...
    <>
      <div ref={rootRef} className={`relative ${className}`}>
        <button
          ...
          aria-haspopup="menu"
          onClick={() => {
            if (!isSignedIn) void openProfile()
        ...
        {menuOpen && isSignedIn ? (
          <div
            role="menu"
            className="absolute right-0 top-full z-[200] mt-1 min-w-[10.5rem] overflow-hidden rounded-xl border border-brand-border bg-brand-surface py-1 shadow-lg"
          >
            <button
              type="button"
              role="menuitem"
